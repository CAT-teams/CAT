...
from operations import ReLUProj, Conv2d2

torch.nn.Conv2d = Conv2d2
torch.nn.ReLU = ReLUProj
import torch.distributed as dist

from ssd.engine.inference import do_evaluation, do_run
...
def main():
    ...
    if not args.skip_test:
        ...
        eval_res = do_evaluation(cfg, model, distributed=args.distributed)
        print('Final entropy: {}'.format(eval_res[-1]['metrics']['entropy']))
